        ...
        <form method="GET" action="{{ route('schedules.index') }}"
            ...
            <div class="mx-auto">
                <div class = "p-4  mb-4 text-right text-xl text-bold      text-red-700 bg-white border-3xl border border-green-500   dark:bg-red-200 dark:text-red-800"
                    role="alert">
                    اسناد مواد الصف الخامس الابـتدائي
                </div>
                    ...
                    <table>
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                @php $class = $classrooms->where('name', 'خامس ابتدائي')    @endphp
                                ...
                                @for ($i = 1; $i <= $school_classess->first()->number; $i++)
                                    {!! $i == 1 ? '  <th>فصل خامس ( أ )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 2 ? '  <th>فصل خامس ( ب )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 3 ? '  <th>فصل خامس ( ج )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 4 ? '  <th>فصل خامس ( د )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 5 ? '  <th>فصل خامس ( ه )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 6 ? '  <th>فصل خامس ( و )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 7 ? '  <th>فصل خامس ( ز )<br> مثلاً نوره خالد  ' : '' !!}
                                @endfor
            ...
            <div class="w-full mt-6 p-4  flex-row-reverse flex gap-2">
                <div class=" flex w-1/2   justify-start">
                    <a href="{{ route('schedules.index', ['class_id' => '4']) }}"
