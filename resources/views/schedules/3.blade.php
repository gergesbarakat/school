                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                @for ($i = 1; $i <= $school_classess->first()->number; $i++)
                                    ...
                                    {!! $i == 3 ? '  <th>فصل ثالث ( ج )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 4 ? '  <th>فصل ثالث ( د )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 5 ? '  <th>فصل ثالث ( ه )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 6 ? '  <th>فصل ثالث ( و )<br> مثلاً نوره خالد  ' : '' !!}
                                    {!! $i == 7 ? '  <th>فصل ثالث ( ز )<br> مثلاً نوره خالد  ' : '' !!}
                                @endfor
...
@endif
            ...
            <div class="w-full mt-6 p-4 flex flex-row-reverse gap-2">
                <div class=" flex w-1/2   justify-start">
                    <a href="{{ route('schedules.index', ['class_id' => '2']) }}"
