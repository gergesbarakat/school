        ...
        <form method="GET" action="{{ route('schedules.index') }}"
            ...
            <div class="mx-auto">
                <div class = "p-4  mb-4 text-right text-xl text-bold      text-red-700 bg-white border-3xl border border-green-500   dark:bg-red-200 dark:text-red-800"
                    role="alert">
                    اسناد مواد الصف الثالث المتوسط
                </div>
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    @for ($i = 1; $i <= $school_classess->first()->number; $i++)
                                        {!! $i == 1 ? '  <th>فصل 1/3<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 2 ? '  <th>فصل 2/3<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 3 ? '  <th>فصل 3/3<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 4 ? '  <th>فصل 4/3<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 5 ? '  <th>فصل 5/3<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 6 ? '  <th>6/3<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 7 ? '  <th>فصل 7/3<br> مثلاً نوره خالد  ' : '' !!}
                                    @endfor
                                ...
                                <tr>
                                    ...
                                    @for ($i = 1; $i <= $school_classess->first()->number; $i++)
                                        ...
                                        $g = $schedules
                                            ...
                                            ->first();
                                        ?>
                                        <td><select name="col[{{ $i }}][11]" class="p-2">
                                                <option></option>
            ...
            <div class="w-full mt-6 p-4 flex-row-reverse flex gap-2">
                <div class=" flex w-1/2   justify-start">
                    <a href="{{ route('schedules.index', ['class_id' => '8']) }}"
