                            ...
                            <tr>
                                ...
                                @if (count(value: $school_classess) > 0)
                                    ...
                                    @for ($i = 1; $i <= $school_classess->first()->number; $i++)
                                        {!! $i == 1 ? '  <th style="border: 1px solid #000;">فصل سادس ( أ )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 2 ? '  <th style="border: 1px solid #000;">فصل سادس ( ب )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 3 ? '  <th style="border: 1px solid #000;">فصل سادس ( ج )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 4 ? '  <th style="border: 1px solid #000;">فصل سادس ( د )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 5 ? '  <th style="border: 1px solid #000;">فصل سادس ( ه )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 6 ? '  <th style="border: 1px solid #000;">فصل سادس ( و )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 7 ? '  <th style="border: 1px solid #000;">فصل سادس ( ز )<br> مثلاً نوره خالد  ' : '' !!}
                                    @endfor
                                @endif
