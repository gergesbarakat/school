...
<table>
        ...
        <tr>
            ...
            @if (count(value: $school_classess) > 0)
                ...
                @for ($i = 1; $i <= $school_classess->first()->number; $i++)
                    {!! $i == 1 ? '  <th style="border: 1px solid #000;">فصل 3/1<br> مثلاً نوره خالد  ' : '' !!}
                    {!! $i == 2 ? '  <th style="border: 1px solid #000;">فصل 3/2<br> مثلاً نوره خالد  ' : '' !!}
                    {!! $i == 3 ? '  <th style="border: 1px solid #000;">فصل 3/3<br> مثلاً نوره خالد  ' : '' !!}
                    {!! $i == 4 ? '  <th style="border: 1px solid #000;">فصل 3/4<br> مثلاً نوره خالد  ' : '' !!}
                    {!! $i == 5 ? '  <th style="border: 1px solid #000;">فصل 3/5<br> مثلاً نوره خالد  ' : '' !!}
                    {!! $i == 6 ? '  <th style="border: 1px solid #000;">فصل 3/6<br> مثلاً نوره خالد  ' : '' !!}
                    {!! $i == 7 ? '  <th style="border: 1px solid #000;">فصل 3/7<br> مثلاً نوره خالد  ' : '' !!}
                @endfor
            @endif
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border: 1px solid #000;">ت ناقد</td>
            <td style="border: 1px solid #000;">2</td>
            @if (count(value: $school_classess) > 0)
