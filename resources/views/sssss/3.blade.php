                            ...
                            <tr>
                                ...
                                @if (count(value: $school_classess) > 0)
                                    ...
                                    @for ($i = 1; $i <= $school_classess->first()->number; $i++)
                                        {!! $i == 1 ? '  <th style="border: 1px solid #000;">فصل ثالث ( أ )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 2 ? '  <th style="border: 1px solid #000;">فصل ثالث ( ب )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 3 ? '  <th style="border: 1px solid #000;">فصل ثالث ( ج )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 4 ? '  <th style="border: 1px solid #000;">فصل ثالث ( د )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 5 ? '  <th style="border: 1px solid #000;">فصل ثالث ( ه )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 6 ? '  <th style="border: 1px solid #000;">فصل ثالث ( و )<br> مثلاً نوره خالد  ' : '' !!}
                                        {!! $i == 7 ? '  <th style="border: 1px solid #000;">فصل ثالث ( ز )<br> مثلاً نوره خالد  ' : '' !!}
                                    @endfor
                                @endif
                                ...
                                @if (count(value: $school_classess) > 0)
                                    ...
                                    @for ($i = 1; $i <= $school_classess->first()->number; $i++)
                                        ...
                                        $c = $schedules
                                            ...
                                            ->first();
                                        ?>
                                        <td style="border: 1px solid #000;"> {{ $c != null ? $c->teacher_id : '' }}
                                        </td>
                                    @endfor
                                @endif
