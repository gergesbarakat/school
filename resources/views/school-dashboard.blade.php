<x-app-layout>
    ...
    <div class = "content ml-12 transform ease-in-out duration-500   px-2 md:px-5 pb-4 ">
        ...
        <div class="flex flex-col justify-center items-center w-full">
            ...
            <div class = "p-4  text-right w-full mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800"
                role="alert">
            ...
            {{-- <div class = "p-4  align-center justify-end mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200 dark:text-blue-800"
                role="alert">
